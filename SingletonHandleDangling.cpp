...
public:
	...
	static void releaseInstance(Singleton **ptr)
	{
...
int main()
{
    ...
    Singleton::releaseInstance(&obj1);
    Singleton::releaseInstance(&obj2);
    Singleton::releaseInstance(&obj3);       /// Destructor would called only using this call, because here count is 0
